...
pub async fn fetch_boundary_v1_graph_project_id_boundary_node_id_get(
    configuration: &configuration::Configuration,
    params: FetchBoundaryV1GraphProjectIdBoundaryNodeIdGetParams,
) -> Result<models::BoundaryResponse, Error<FetchBoundaryV1GraphProjectIdBoundaryNodeIdGetError>> {
    let uri_str = format!(
        "{}/v1/graph/{project_id}/boundary/{node_id}",
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<FetchBoundaryV1GraphProjectIdBoundaryNodeIdGetError> =
...
pub async fn fetch_graph_v1_graph_project_id_get(
    configuration: &configuration::Configuration,
    params: FetchGraphV1GraphProjectIdGetParams,
) -> Result<models::GraphResponse, Error<FetchGraphV1GraphProjectIdGetError>> {
    let uri_str = format!(
        "{}/v1/graph/{project_id}",
        configuration.base_path,
        project_id = crate::apis::urlencode(params.project_id)
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<FetchGraphV1GraphProjectIdGetError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn fetch_node_with_neighbors_v1_graph_project_id_node_node_id_get(
    configuration: &configuration::Configuration,
    params: FetchNodeWithNeighborsV1GraphProjectIdNodeNodeIdGetParams,
) -> Result<
    models::NodeNeighborhoodResponse,
    Error<FetchNodeWithNeighborsV1GraphProjectIdNodeNodeIdGetError>,
> {
    let uri_str = format!(
        "{}/v1/graph/{project_id}/node/{node_id}",
        configuration.base_path,
        project_id = crate::apis::urlencode(params.project_id),
        node_id = crate::apis::urlencode(params.node_id)
    );
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<FetchNodeWithNeighborsV1GraphProjectIdNodeNodeIdGetError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn fetch_subtree_v1_graph_project_id_subtree_node_id_get(
    configuration: &configuration::Configuration,
    params: FetchSubtreeV1GraphProjectIdSubtreeNodeIdGetParams,
) -> Result<models::SubtreeResponse, Error<FetchSubtreeV1GraphProjectIdSubtreeNodeIdGetError>> {
    let uri_str = format!(
        "{}/v1/graph/{project_id}/subtree/{node_id}",
        configuration.base_path,
        project_id = crate::apis::urlencode(params.project_id),
        node_id = crate::apis::urlencode(params.node_id)
    );
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<FetchSubtreeV1GraphProjectIdSubtreeNodeIdGetError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
