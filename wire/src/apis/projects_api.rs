...
pub async fn create_project_v1_projects_post(
    configuration: &configuration::Configuration,
    params: CreateProjectV1ProjectsPostParams,
) -> Result<models::ProjectCreateResponse, Error<CreateProjectV1ProjectsPostError>> {
...
pub async fn delete_project_v1_projects_project_id_delete(
    configuration: &configuration::Configuration,
    params: DeleteProjectV1ProjectsProjectIdDeleteParams,
) -> Result<(), Error<DeleteProjectV1ProjectsProjectIdDeleteError>> {
    let uri_str = format!(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DeleteProjectV1ProjectsProjectIdDeleteError> =
...
pub async fn list_projects_v1_projects_get(
    configuration: &configuration::Configuration,
    params: ListProjectsV1ProjectsGetParams,
) -> Result<models::ProjectsListResponse, Error<ListProjectsV1ProjectsGetError>> {
    let uri_str = format!("{}/v1/projects", configuration.base_path);
...
pub async fn patch_project_v1_projects_project_id_patch(
    configuration: &configuration::Configuration,
    params: PatchProjectV1ProjectsProjectIdPatchParams,
) -> Result<models::ProjectPatchResponse, Error<PatchProjectV1ProjectsProjectIdPatchError>> {
    let uri_str = format!(
        "{}/v1/projects/{project_id}",
        configuration.base_path,
        project_id = crate::apis::urlencode(params.project_id)
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PatchProjectV1ProjectsProjectIdPatchError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
